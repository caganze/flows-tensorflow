...
python train_tfp_flows.py \\
    ...
    --pid {particle_pid} \\
    --halo_id {halo_id} \\
    --particle_pid {particle_pid} \\{' \\' + chr(10) + '    --n_subsample 1000 \\' + chr(10) + '    --n_epochs 10 \\' + chr(10) + '    --patience 5 \\' + chr(10) + '    --batch_size 128' if test_mode else ' \\' + chr(10) + '    --max_epochs 200 \\' + chr(10) + '    --patience 20 \\' + chr(10) + '    --batch_size 512'} \\
    --learning_rate 1e-3 \\
    --flow_layers 8 \\
    --hidden_units 64 \\
    --use_gpu
