...
process_particle() {
    ...
    local adaptive_epochs adaptive_batch_size adaptive_n_layers adaptive_hidden_units adaptive_learning_rate
    ...
    if [[ $particle_size -gt 100000 ]]; then
        ...
        adaptive_batch_size=512
        adaptive_n_layers=3
        adaptive_hidden_units=320
        adaptive_learning_rate=4e-4
    ...
    # Train the flow
    {
        ...
        python train_tfp_flows.py \
            ...
            --n_layers $adaptive_n_layers \
            --hidden_units $adaptive_hidden_units \
            --use_kroupa_imf \
